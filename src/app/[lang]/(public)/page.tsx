                ...
                >
                  ...
                  {event.sublinks.map((sublink) => (
                    <React.Fragment key={sublink.linkText}>
                      <p
                        className={`font-heading py-0 text-l text-left ${index % 2 === 0 ? 'text-secondary' : 'text-accent'}`}
                      >
                        {sublink.text}
                      </p>
                      <p
                        className={`font-heading py-2 text-l text-left underline ${index % 2 === 0 ? 'text-secondary' : 'text-accent'}`}
                      >
